...
The application accepts configuration files formatted with key-value pairs (colon-separated).
...
* **Anticipated Schedule:**
  * *Week 1:* Architecture design, grid domain model, and config parser.
  * *Week 2:* Generation algorithms, BFS pathfinder, and terminal display.
  * *Week 3:* '42' mask implementation, imperfect maze loops, packaging, and defense preparation.
* **Actual Timeline:**
